...
parser.add_argument('--url', action="store", default="http://169.254.253.219/", help="the url of the camera, including http://", required=True)
parser.add_argument('--type', action="store", default="ir", help="the type of image", choices = ['msx','ir','visual'])
